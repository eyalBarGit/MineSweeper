...
/********************************************* -  MODEL - ****************************************/
//CR: all the globals starts with g that is good :)
var gBoard;
...
var gHintCounter = 3;
var gCellContent;
//CR: gBtn is generel name not good
var gBtn;
// var gScore = 0
...
//CR: initGame and newGame sounds like the same function
...
//CR: gameOver should check if the game is over and should be here clearInterval to stop the time
function GameOver() {
    gGame.isOn = false;
...
function getDiffucultyLevel(cellCount, numOfMines) {
    ...
    //CR: same here you can use the initGame function or make a resetFunction instead to reapet your code
    gBoard = buildBoard(gLevel.SIZE);
    renderBoard(gBoard);
    clearInterval(gWatch)
    startMining();
        ...
        for (var j = 0; j < row.length; j++) {
            ...
            if (cell.isShown) {
                if (cell.isMine) {
                    ...
                    //CR: you could use switch case here
...
//CR: gBtn is a generic name not good
...
/**************************************************** - CREATE MINES - **********************************************/
//CR: too much spaces between lines
function createMines(board) {



    for (var i = 0; i < gLevel.MINES; i++) {
    //CR: var iMine or jMine is not a good name
        var iMine = getRandomInt(0, board.length - 1)
        var jMine = getRandomInt(0, board.length - 1)
        //CR: if its not a mine and not isShown so set mine to true? confusing logic
...
/*************************************************************************************************************/
//CR: you dont render flag icon or image
